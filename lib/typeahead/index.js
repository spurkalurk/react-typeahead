...
var Typeahead = React.createClass({
  ...
  getOptionsForValue: function getOptionsForValue(value, options, nextProps) {
    if (this._shouldSkipSearch(value)) {
      return [];
    }

    var searchOptions = this._generateSearchFunction(nextProps);
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    var typeheadOptionsState = {
      searchResults: this.getOptionsForValue(this.state.entryValue, nextProps.options, nextProps)
    };
  ...
  _generateSearchFunction: function(props) {
    const { filterOption, searchOptions } = props || this.props;
